...
import { storeFile, getFileData } from '../../lib/storage';
    ...
    <div className="flex flex-col h-full">
      ...
      <div 
        className={`flex-1 overflow-y-auto p-2 ${
          dragOver ? 'bg-[var(--fuse-accent)]/10 border-2 border-dashed border-[var(--fuse-accent)]' : ''
        }`}
        onDrop={handleDrop}
        ...
        {!isImporting && mediaItems.length === 0 && (
          <div className="flex flex-col items-center justify-center h-full text-center px-4">
            <div className="w-12 h-12 rounded-xl bg-[var(--fuse-bg-tertiary)] flex items-center justify-center mb-3">
              <svg className="w-6 h-6 text-[var(--fuse-text-secondary)]" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M7 4v16M17 4v16M3 8h4m10 0h4M3 12h18M3 16h4m10 0h4M4 20h16a1 1 0 001-1V5a1 1 0 00-1-1H4a1 1 0 00-1 1v14a1 1 0 001 1z" />
              </svg>
            </div>
            <p className="text-sm text-[var(--fuse-text-secondary)] mb-1">
              Drop media files here
            </p>
            <p className="text-xs text-[var(--fuse-text-secondary)]/60">
  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 flex items-center justify-center">
        <svg className="w-8 h-8 text-[var(--fuse-text-secondary)]/30" fill="currentColor" viewBox="0 0 24 24">
